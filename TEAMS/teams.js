...
searchInput.addEventListener("input", () => {
  ...
  if (filtered.length === 0) {
    cont.innerHTML = "<p style='color:white; text-align: center; background: rgba(0,0,0,0.6); padding: 20px; border-radius: 8px; height: 100px; line-height: 100px; width: 300px; font-size: 35px;'>No teams found.</p>";
    return;
  }
  display(filtered);
});
